...
{{% figure src="airbus-threeclass.png" caption="A Regular Airline's Three Class System."  %}}
...
{{% figure src="airbus-income.png" caption="Air Gini: We Like to Fly the Way You Like to Live."  %}}
