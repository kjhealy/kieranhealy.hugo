...
{{% figure src="workflow-rmd-md.png" alt="Workflow diagram" caption="I promise this is less insane than it appears" %}}


<!-- {{% img src="workflow-rmd-md.png" %}} -->
...
{{% figure src="pandoc-template-html-output-sample.png" caption="HTML output from Pandoc" %}}


The PDF output, meanwhile, [can be viewed here](article-markdown.pdf). Both look quite nice. The relevant sections of the Makefile show the pandoc commands that generate the output files from the markdown input. The Makefile section for producing PDF output looks like this:
...
{{% figure src="pandoc-template-rmd-output-sample.png" caption="Sample PDF output from an Rmd file, with figures and tables generated automatically. Click the image for a PDF version" link="article-knitr.pdf" %}}
...
{{% figure src="Marked2-preferences.png" caption="Marked's Preference dialog" %}}
...
{{% figure src="Marked2-Preview.png" caption="Previewing in HTML with Marked"%}}
