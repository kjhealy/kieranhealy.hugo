...
{{% figure src="cite-dotplot-by-decade-grouped-prod.png" alt="Top 10 from Each Decade" caption="Sociology's Top 10 Most-Cited Papers from Each Decade, based on all-time citations in WoS." %}}

(You can get a [PDF version of this figure](cite-dotplot-by-decade-grouped-prod.pdf) if you want a closer look.) 
