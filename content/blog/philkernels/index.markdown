...
I began very simply with figures showing the [Mean, Median and Mode scores](website-mmm-alltop50.png), which they were already reporting numerically. I also made some [small-multiple histograms](website-histogram-alltop50.png) which are good for showing the spread of votes within departments. For data like this, though, we are interested in a rank-ordered comparison of departments that can be taken in by scanning along a single axis. The tabular faceting of the histograms doesn't quite facilitate this. So in addition to those I did kernel density plots of the various rankings as well. Here's the one for the Overall Top 50 departments.

{{% figure src="website-kernel-alltop50.png" alt="Ranking Kernel Plot" caption="Kernel Density Plots of the 2014 PGR Top 50." %}}

You can get [a PDF version of this plot](website-kernel-alltop50.pdf) as well.

There are corresponding plots for the US Top 50 ([PNG](website-kernel-US50.png), [PDF](website-kernel-US50.pdf)), the UK ([PNG](website-kernel-uk.png), [PDF](website-kernel-uk.pdf)), Canada ([PNG](website-kernel-canada.png), [PDF](website-kernel-canada.pdf)), and Australia/New Zealand ([PNG](website-kernel-ANZ.png), [PDF](website-kernel-ANZ.pdf)).
...
{{% figure src="website-histogram-alltop50.png" alt="Vote Histograms by Rank" caption="The 2014 PGR Top 50: Vote Distribution by Department." %}}

You can get [a PDF version of this plot](website-histogram-alltop50.pdf) as well. And once again there are also equivalent plots for the US top 50 ([PNG](website-histogram-US50.png), [PDF](website-histogram-US50.pdf)), the UK ([PNG](website-histogram-UK.png), [PDF](website-histogram-UK.pdf)), Canada ([PNG](website-histogram-canada.png), [PDF](website-histogram-canada.pdf)), and Australia/New Zealand ([PNG](website-histogram-ANZ.png), [PDF](website-histogram-ANZ.pdf)).
