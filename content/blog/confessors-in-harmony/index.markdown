...
flow from his rejection of the constraints of "civilization".[^1] He coined the
term "feminism". His vision was of a kind of liberation of human creative
...
harmonious. As is often the case in utopian visions, there's a desire to have
...
author to accomplish the hard parts.

A side effect of this line of thought is that the twin beliefs in rational
...
optimizes on the combination of people's present sexual wants and their basic
personality types:
...
> city. ... The art of the *sympathist*, which is unknown in civilization,
...
> identities that will be most attractive to each of the adventurers.
>
>
> When an individual is still basking in the enthusiasm of a romantic passion,
...
> matching individuals from whom he may make his choice.
>
>
> All of this work, which involves the use of algebraic formulas, should be
...
> memories instead of delicious illusions.
>
>
...
{{% figure src="fourier-formula.png" alt="Fourier's matching system." caption="I wouldn't rely on it myself." %}}

In any case, I like the idea of a full filing system containing an information
...
[anything in contemporary society works](https://theordinalsociety.com).


[^1]: Always a derogatory term for Fourier, in contrast with "Harmony", the overall name for his utopia.

[^2]: Here he means what is in his view the simplest kind of attraction, that of opposites.
