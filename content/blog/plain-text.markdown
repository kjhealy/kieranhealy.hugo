...
{{% figure src="http://kieranhealy.org/files/misc/pandoc-template-rmd-output-sample.png" caption="Sample PDF output from an Rmd file, with figures and tables generated automatically." link="http://kieranhealy.org/files/misc/article-knitr.pdf" %}}
